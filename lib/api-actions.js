...
var search_shows = [arg('query'), arg('limit', true), arg('seasons', true)]
...
module.exports = {
	...
	'search' : [
		...
		{ method: 'shows', type: 'GET', parameters: search_shows },
	...
	'user' : [ 
		...
		{ method: 'progress/collected', type: 'GET', parameters: [arg('username'), arg('title'), arg('sort', true), arg('extended', true)] },
